...
import { Form, Control } from 'components/bulma/layout/Form';
...
const Home: React.FC = () => {
  return (
    <div>
      ...
      <Tabs>
        <Tab to="/#pictures">Pictures</Tab>
        <Tab to="/#music">Music</Tab>
      ...
      <Box>
        ...
        <Assignment
          title="Study Bulma"
          points={1}
          description="Watch and follow the Traversy Media crash course on Bulma"
          noFooter
        />
        <Assignment
          title="Read a book"
